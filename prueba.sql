...
select all from USUARIO where apelUsuario='jaramillo' AND idUsuario='cesar' && direccion='pereira';

int mostrar(UPDATE USUARIO
SET apelUsuario = 'Jaramillo'
WHERE nomUsuario = 'Agustin'or nomUsuario = 'robertin'
AND fechaExpCarnet = '20-mayo-2014')
{
	while(apelUsuario != NULL)
	{
...
int mostrar(int a){
	...
	foreach (apelUsuario!=null as m=select all from USUARIO where apelUsuario='jaramillo' AND idUsuario='cesar' && direccion='pereira'){
